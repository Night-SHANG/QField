...
5. “附近点位”“附近管线”会直接列出结果；每条结果提供“地图”定位和“详情”查看。地图上直接点击单个供水点/管线时也会自动打开详情并缩放到对象。
...
8. “我的位置”标记可以随时隐藏/显示；隐藏只影响地图上的定位图标，不会停止 GNSS 定位，因此人在设施点上时可以先隐藏自己的图标再点击点位。
9. QField 原生的图层树和 Map Theme 属于专业 GIS 配置，现场版默认隐藏；底层图层能力仍保留，后续底图切换会以明确的“地图样式”入口提供。
10. “备份 / 导出”继续复用 QField 原生 Project Folder 和压缩导出能力。
